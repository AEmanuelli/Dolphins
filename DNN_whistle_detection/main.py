...
def main():
    ...
    saving_folder_image = '/users/zfne/emanuell/Documents/GitHub/Dolphins/DNN_whistle_detection/test_fullpipeline'
    ...
    for fichier in os.listdir(dossier_csv):
        if fichier.endswith(".csv"):  # Vérifie si le fichier est un fichier CSV
            ...
            if fichier_video:
                filename, channel = os.path.splitext(fichier)[0].split("_")[:2]
