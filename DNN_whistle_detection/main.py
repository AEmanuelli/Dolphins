...
if __name__ == "__main__":
    ...
    dossier_csv = "/media/DOLPHIN_ALEXIS1/Analyses_alexis/2023_analysed"  # Update with your actual path
    model_path = "models/model_vgg.h5"
    recording_folder_path = "/media/DOLPHIN_ALEXIS1/2023"  # Update with your actual path
    saving_folder = '/media/DOLPHIN_ALEXIS1/Analyses_alexis/2023_analysed'  # Update with your actual path
